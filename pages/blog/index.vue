...
div.container.mx-auto.text-white.pt-24
  header.m-2.p-4.bg-slate-500.rounded-xl(class="md:px-12")
  ...
  section.m-2.p-4.bg-opacity-20.bg-dark-900.rounded-xl(v-else v-for="item in data.list" class="md:p-12")
